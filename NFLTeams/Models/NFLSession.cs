...
namespace NFLTeams.Models
{
    public class NFLSession
    {
        ...
        public void SetName(string username = "friend")             //saves default session data for the NameKey
        {
            session.SetString(NameKey, username);
        }

        public string GetName() => session.GetString(NameKey);     //creates a method that retrieves session data for the NameKey
